// let theStateOfThings = function () {
    let theStateOfThings = () => {
        ...
        let checkOneSection = ($sec) => {
            ...
            if (top < winH && bottom > 400) {
                infoForElement += `<li class="show">${$sec.querySelector('h2').textContent}</li>`
            } else {
                infoForElement += `<li class="hide"><a href="#${theId}">${$sec.querySelector('h2').textContent}</a></li>`
            }
        }
